...
// NOTE: using separate list instead of map's keys() because keys() is unordered
// and we need order so that display string is consistent.
static const QList<int> UAC_MASK_LIST = {
    UAC_SCRIPT,
    UAC_ACCOUNTDISABLE,
...
static const QHash<int, QString> UAC_MASK_NAME_MAP = {
    {UAC_SCRIPT, "SCRIPT"},
