...
private slots:
    void on_add_link();
    void on_edit();
    void update_policy_item_data(const QString &policy_dn, const QString &ou_dn, bool is_checked, int option);
...
private:
    ...
    void set_policy_item_icon(const QModelIndex &policy_index, bool is_checked, int option);
};
