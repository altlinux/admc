...
void MainWindow::setup_simple_settings() {
    const QHash<QString, QAction *> bool_action_map = {
        ...
        {SETTING_use_system_credentials, ui->action_use_system_credentials}
    };
    ...
    const QList<QString> simple_setting_list = {
        ...
        SETTING_use_system_credentials
    };

    if (settings_get_variant(SETTING_use_system_credentials).isNull()) {
        settings_set_variant(SETTING_use_system_credentials, true);
    }
