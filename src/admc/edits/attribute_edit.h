...
public:
    ...
    virtual void load(const AdObject &attributes) = 0;
...
void load(const AdObject &attributes);\
bool changed() const;\
...
void load_attribute_edits(QList<AttributeEdit *> edits, const AdObject &attributes);
